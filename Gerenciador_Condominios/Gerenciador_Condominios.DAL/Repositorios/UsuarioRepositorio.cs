...
namespace Gerenciador_Condominios.DAL.Repositorios
{
    public class UsuarioRepositorio : RepositorioGenerico<Usuario>, IUsuarioRepositorio
    {
        ...
        public UsuarioRepositorio(AppDbContext contexto, UserManager<Usuario> gerenciadorUsuarios, SignInManager<Usuario> gerenciadorLogin) : base(contexto)
        {
            _contexto = contexto;
        ...
        public int VeririfcarSeExisteRegistro()
        {
            try
            {
